...
import PreguntaCRUD.PreguntaModificar;
 ...
 * @author Pwned
 */
public class RespuestaModificar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String getRespuesta = request.getParameter("getRespuesta");
            String getIdpregunta= request.getParameter("getIdpregunta");
            dto.setIdrespuesta(Integer.parseInt(iditem));
            dto.setRespuesta(getRespuesta);
