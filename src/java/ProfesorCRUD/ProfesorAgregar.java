 ...
 * @author Pwned
 */
public class ProfesorAgregar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            pdf.PDFUsuarioP(dto, "REGISTRO DE USUARIO ", response, request);
            EnvioEmail mail = new EnvioEmail();                   
            String ruta="C:\\Users\\Pwned\\JaspersoftWorkspace\\MyReports\\"+ matricula+".pdf";
            mail.processRequest(request, response, dto.getEmail(),"Correo generado autoaticamente al momento de su registro", ruta, "REGISTRO DE PROFESOR");
