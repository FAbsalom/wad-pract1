 ...
 * @author Pwned
 */
public class GraficaAlumnosxMateria extends HttpServlet {
    
    Conexion conn = new Conexion();
    private static final String sql_Grafica = "{call AlumnosxMateriaC()}";


    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        String nombreGrafica="Alumnos Por Materia";
        ...
        String nombreArchivo="AlumnosxMateria.jpeg";
