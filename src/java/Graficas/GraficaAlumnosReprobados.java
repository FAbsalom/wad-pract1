 ...
 * @author Pwned
 */
public class GraficaAlumnosReprobados extends HttpServlet {

    Conexion conn = new Conexion();
    private static final String sql_Grafica = "{call AlumnosReprobadosxMateria()}";

    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        String nombreGrafica = "Alumnos Reprobados Por Materia";
        ...
        String nombreArchivo = "AlumnosReprobadosxMateria.jpeg";
