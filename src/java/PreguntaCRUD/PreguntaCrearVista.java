...
public class PreguntaCrearVista extends HttpServlet {
...
protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            out.println("<!DOCTYPE html>\n"
                    ...
                    + "    <title>Dar de Alta Pregunta</title>\n"
                    ...
                    + "</div>\n"
                    + "    \n"
                    + "<form class=\"form-horizontal\" id=\"\" action=\"PreguntaAgregar\" method=\"post\">     \n"
                    + "    <h2>Introduzca los datos</h2>\n"
                    + "\n"
                    + "    <div class=\"line\" text-center></div>\n"
                    + "    <LABEL for=\"getPregunta\" style=\"text-align:center\">Pregunta: </LABEL>            \n"
                    + "		<INPUT style=\"text-align:center\" type=\"text\" name=\"getPregunta\" id=\"getPregunta\">                    \n"
                    + "    <LABEL for=\"getIdexamen\" style=\"text-align:center\">IdExamen: </LABEL>            \n"
                    + CargaSelect.conExamen()
                   // + "        <INPUT style=\"text-align:center\" type=\"text\" name=\"getIdexamen\" id=\"getIdexamen\">                    		\n"
